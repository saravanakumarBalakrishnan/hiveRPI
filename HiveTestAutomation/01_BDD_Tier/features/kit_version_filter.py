...
class UIClass(Frame):
    def __init__(self, parent):
        ...
        self.oKitCombinationList = [('Nano2', 'SLR2', 'SLT3'), ('Nano2', 'SLR1', 'SLT3'), ('Nano2', 'SLR2', 'SLT2'),
                                    ('Nano2', 'SLR1', 'SLT2'),
                                    ('Nano1', 'SLR2', 'SLT3'), ('Nano1', 'SLR1', 'SLT3'), ('Nano1', 'SLR2', 'SLT2'),
                                    ('Nano1', 'SLR1', 'SLT2'), ('Nano1', 'SLT1')]
        ...
        a = Radiobutton(self.EnvFrame, text='isopInternProd', padx=15, activebackground='Lawn Green',
                        highlightcolor='green', variable=self.EnvironmentMW, value='isopInternProd', indicatoron=0,
                        command=self.load_users_env_select)
        a.grid(column=1, row=0)
        Radiobutton(self.EnvFrame, text='isopBeta', padx=15, variable=self.EnvironmentMW, value='isopBeta',
                    indicatoron=0, command=self.load_users_env_select).grid(column=3, row=0)
        Radiobutton(self.EnvFrame, text='isopStaging', padx=15, variable=self.EnvironmentMW, value='isopStaging',
                    indicatoron=0, command=self.load_users_env_select).grid(column=4, row=0)
        Radiobutton(self.EnvFrame, text='isopProd', padx=15, variable=self.EnvironmentMW, value='isopProd',
                    indicatoron=0, command=self.load_users_env_select).grid(column=5, row=0)
        ...
        self.oNano2FW = Listbox(self.selectFrame, listvariable=self.Nano2FW, width=intCombWidth, height=4,
        ...
        self.oNano1FW = Listbox(self.selectFrame, listvariable=self.Nano1FW, width=intCombWidth, height=4,
                                exportselection=False)
        ...
        self.oSLR2FW = Listbox(self.selectFrame, listvariable=self.SLR2FW, width=intCombWidth, height=4,
                               exportselection=False)
        ...
        self.oSLR1FW = Listbox(self.selectFrame, listvariable=self.SLR1FW, width=intCombWidth, height=4,
                               exportselection=False)
        ...
        self.oSLT3FW = Listbox(self.selectFrame, listvariable=self.SLT3FW, width=intCombWidth, height=4,
                               exportselection=False)
        ...
        self.oSLT2FW = Listbox(self.selectFrame, listvariable=self.SLT2FW, width=intCombWidth, height=4,
                               exportselection=False)
        ...
        self.oSLT1FW = Listbox(self.selectFrame, listvariable=self.SLT1FW, width=intCombWidth, height=4,
                               exportselection=False)
        ...
        ttk.Label(self.resultHeadFrame, text='                           Matching Users', font=self.subHeadFont).grid(
            row=1, column=3)
        ...
        ttk.Label(self.resultHeadFrame, text='                                            Response',
                  font=self.subHeadFont).grid(row=1, column=5)
                ...
                if not 'supportsHotWater' in oNode['attributes']:
                    if 'model' in oNode['attributes']:
                        ...
                        if 'SLT' in strModel:
                            ...
                            oDeviceVersionDict['Thermostat'] = {"model": strModel, "version": intSoftwareVersion,
                                                                'mac_id': strSLTMacID}
                        elif 'SLR' in strModel:
                            # oDeviceVersionDict['Boiler Module'] = strModel + '$$' + intSoftwareVersion
                            oDeviceVersionDict['Boiler Module'] = {"model": strModel, "version": intSoftwareVersion,
                                                                   'mac_id': strSLRMacID}
            ...
            for oKitComb in oSelectCombList:
                ...
                for oUserKey in oDeviceListJson:
                    ...
                    if not 'errors' in oUser:
                            ...
                            if oUser['HUB']['model'] == strHubType:
                                ...
                                if oUser['Thermostat']['model'] == strTHFWType:
                                    ...
                                    if not ((strBMType == '') and ('Boiler Module' not in oUser)):
                                        if ((strBMType == '') and ('Boiler Module' in oUser)) or (
                                                    (strBMType != '') and ('Boiler Module' not in oUser)):
                        ...
                        if boolUserMatching and boolUserHUbMatching and boolUserTHMatching and boolUserBMMatching: oMatchingUsers.append(
                            oUserKey)
