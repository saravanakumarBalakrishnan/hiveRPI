                    ...
                    if not 'supportsHotWater' in oNode['attributes']:
                        if 'hardwareVersion' in oNode['attributes']:
                            ...
                            if 'NANO' in intHardwareVersion:
                                ...
                                oDeviceVersionDict['HUB'] = {"model": intHardwareVersion,
                                                             "version": intSoftwareVersion}  # ,  'mac_id': strHubMacId}
                    ...
                    if oNode['attributes']['supportsHotWater']['reportedValue'] == True and 'stateHotWaterRelay' in \
                        ...
                        if boolWater:
                            ...
                            if self.Node.get() == 'Schedule':
                                ...
                                return {"currentMode": self.mode,
                                        "activeHeatCoolMode": oAttributeList['activeHeatCoolMode'],
                                        "activeScheduleLock": oAttributeList['activeScheduleLock'],
                                        "activeOverrides": oAttributeList['activeOverrides'],
                                        "scheduleLockDuration": oAttributeList["scheduleLockDuration"],
                                        "stateHotWaterRelay": oAttributeList['stateHotWaterRelay']}
                        ...
                        if not boolWater and 'stateHeatingRelay' in oNode['attributes']:
                            ...
                            if self.Node.get() == 'Schedule':
                                ...
                                return {"currentMode": self.mode,
                                        ...
                                        "activeOverrides": oAttributeList['activeOverrides'],
                                        "scheduleLockDuration": oAttributeList["scheduleLockDuration"],
                                        "stateHeatingRelay": oAttributeList['stateHeatingRelay']}
