...
Feature: Consists of scenario that validates the network topology between devices
  ...
  @SC-TT-SC01-32 @PairingTest
  Scenario Outline: SC-TT-SC01-32_The given devices are paired and unpaired sequentially and validated via plug
  ...
  @SC-TT-SC01-33 @PairingTest
  Scenario Outline: SC-TT-SC01-33_The given devices are paired and unpaired sequentially and validated via plug
	Given The devices are paired with the Hive Hub
	And the given attenuation is set on the network
	  | Atten | DB |
	  | 1_2   | 0  |
  ...
  @SC-TT-SC01-34 @PairingTest
  Scenario Outline: SC-TT-SC01-34_The given devices are paired and unpaired sequentially and validated via plug
	Given The devices are paired with the Hive Hub
	And the given attenuation is set on the network
	  | Atten | DB |
	  | 1_2   | 0  |
  ...
  @SC-TT-SC01-35 @PairingTest
  Scenario Outline: SC-TT-SC01-35_The given devices are paired and unpaired sequentially and validated via plug
	Given The devices are paired with the Hive Hub
	And the given attenuation is set on the network
	  | Atten | DB |
	  | 1_2   | 0  |
