...
Feature: Consists of scenario that validates the network topology between devices
  ...
  @SC-TT-SC01-24 @PairingTest
  Scenario Outline: SC-TT-SC01-24_The given devices are paired and unpaired sequentially and validated via plug
  ...
  @SC-TT-SC01-25 @PairingTest
  Scenario Outline: SC-TT-SC01-25_The given devices are paired and unpaired sequentially and validated via plug
	Given The devices are paired with the Hive Hub
	And the given attenuation is set on the network
	  | Atten | DB |
	  | 1_2   | 0  |
  ...
  @SC-TT-SC01-26 @PairingTest
  Scenario Outline: SC-TT-SC01-26_The given devices are paired and unpaired sequentially and validated via plug
	Given The devices are paired with the Hive Hub
	And the given attenuation is set on the network
	  | Atten | DB |
	  | 1_2   | 0  |
  ...
  @SC-TT-SC01-27 @PairingTest
  Scenario Outline: SC-TT-SC01-27_The given devices are paired and unpaired sequentially and validated via plug
	Given The devices are paired with the Hive Hub
	And the given attenuation is set on the network
	  | Atten | DB |
	  | 1_2   | 0  |
