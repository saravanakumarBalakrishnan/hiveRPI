...
Feature: Performs regression on Active Light for the Device type TWGU10Bulb01UK
  ...
  @TWGU10Bulb01UK_RegressionTest @SC-ZT-39tochange @ZigbeeDumpTest
  ...
  @TWGU10Bulb01UK_RegressionTest @SC-RG-NT-JN01-20 @PairingTest
  Scenario: SC-RG-NT-JN01-18_The given devices are paired and unpaired sequentially and validated once in all Zigbee Channels
    ...
    When the below devices are paired and unpaired sequentially on all Zigbee Channels and validated via Telegesis
      ...
      | AL         | TWGU10Bulb01UK | 00158D00014FADF4 |

  @TWGU10Bulb01UK_RegressionTest @SC-NT-JN05-16 @Generic
  ...
  @TWGU10Bulb01UK_RegressionTest @SC-FT-71 @FirmwareTest
  Scenario: SC-FT-67_Downgrade firmware of the device and later upgrade the firmware to the previous version
    ...
    When the below list of DeviceName of DeviceType is upgraded and downgraded between DeviceVersion1 and DeviceVersion2 via Telegisis
      ...
      | AL         | TWGU10Bulb01UK | NA             | 11160002       |
      | AL         | TWGU10Bulb01UK | 11200002       | NA             |

  @TWGU10Bulb01UK_RegressionTest @SC-SP-DP01-20 @DevicePairingTest
  ...
  @TWGU10Bulb01UK_RegressionTest @SSC-TW-04 @ActiveLight
  ...
  @TWGU10Bulb01UK_RegressionTest @SC-BT-47 @ZigbeeBindingTest
