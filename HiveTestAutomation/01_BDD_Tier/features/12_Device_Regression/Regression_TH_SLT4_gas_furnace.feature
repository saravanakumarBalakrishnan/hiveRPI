...
# Created by bharath.gopalan at 20/10/2017


  Feature: Regression cases for SLT4 stat in dual fuel hybrid
    @SLT4_RegressionTest_GasFurnace @SC-MT-FT-13
      Scenario Outline: SC-MT-FT-13_verify in the gas furnace mode , Fan turns on when there is a cooling demand
    ...
    @SLT4_RegressionTest_GasFurnace @SC-MT-FT-14
      Scenario Outline: SC-MT-FT-14_verify in the gas furnace mode , The fan should not be turned when there is a heating demand
        Given the TGstick is paired with the SLT4 thermostat and the device is switched to  <temp_scale> scale
    ...
    @SLT4_RegressionTest_GasFurnace @SC-VM-01
      Scenario Outline: SC-VM-01_verify if the user is able to set vacation mode
        Given the TGstick is paired with the SLT4 thermostat and the device is switched to  <temp_scale> scale
    ...
    @SLT4_RegressionTest_GasFurnace @SC-VM-02
      Scenario Outline: SC-VM-02_verify Check if the user is able to Cancel the vacation mode
        Given the TGstick is paired with the SLT4 thermostat and the device is switched to  <temp_scale> scale
        When The vacation mode is set for 3 minutes from the current stat time
    ...
    @SLT4_RegressionTest_GasFurnace @SC-VM-03
      Scenario Outline: SC-VM-03_verify if the vacation mode override the current settings and cancel any quick heating and cooling
        Given the TGstick is paired with the SLT4 thermostat and the device is switched to  <temp_scale> scale
    ...
    @SLT4_RegressionTest_GasFurnace @SC-VM-04
      Scenario Outline: SC-VM-04_verify if the vacation mode has ended , It should restore the previous stat state (which was previously in dual hold mode)
        Given the TGstick is paired with the SLT4 thermostat and the device is switched to  <temp_scale> scale
    ...
    @SLT4_RegressionTest_GasFurnace @SC-VM-05
      Scenario Outline: SC-VM-05_verify if the vacation mode has ended , It should restore the previous stat state (which was previously in Heat hold or cool hold mode)
        Given the TGstick is paired with the SLT4 thermostat and the device is switched to  <temp_scale> scale
        When the device is in <mode> mode and the required temperature is set to 5 points <points> the ambient temperature
        When The vacation mode is set for 3 minutes from the current stat time
        Then it should be switched to mode OFF
        When The holiday mode ends after 3 minutes
        Then it should be switched to mode <mode>
        ...
        Examples: Different heat modes
        |temp_scale|mode          | points     |
        |CELCIUS   |HEAT HOLD     | above      |
        |CELCIUS   |COOL HOLD     | below      |


  @SLT4_RegressionTest_GasFurnace @SC-CH-MC28
    Scenario Outline: SC-CH-MC28_verify if the user is able to switch to different modes
      Given the TGstick is paired with the SLT4 thermostat and the device is switched to  <temp_scale> scale
  ...
  @SLT4_RegressionTest_GasFurnace @SC-UC-03
    Scenario Outline: SC-UC-03_verify if the stat is able to switch between different temperature Scale
      Given the TGstick is paired with the SLT4 thermostat and the device is switched to  <temp_scale> scale
  ...
  @SLT4_RegressionTest_GasFurnace @SC-MT-31
    Scenario Outline: SC-MT-31_verify if the stat is able to be set to quick cool and heat mode
      Given the TGstick is paired with the SLT4 thermostat and the device is switched to  <temp_scale> scale
      When the device is in <device_mode> mode and the required temperature is set to <number> points <value> the ambient temperature
  ...
  @SLT4_RegressionTest_GasFurnace @SC-MT-37
    Scenario Outline: SC-MT-37_verify the override values in heat boost and heat hold mode
      Given the TGstick is paired with the SLT4 thermostat and the device is switched to  <temp_scale> scale
  ...
  @SLT4_RegressionTest_GasFurnace @SC-MT-38
    Scenario Outline: SC-MT-38_verify the override values in cool boost and cool hold mode
      Given the TGstick is paired with the SLT4 thermostat and the device is switched to  <temp_scale> scale
      When the device is in <device_mode> mode and the required temperature is set to <number> points <value> the ambient temperature without protection timer validation
  ...
  @SLT4_RegressionTest_GasFurnace @SC-PT-04
    Scenario Outline: SC-PT-04_verify if the protection timer functionality
      Given the TGstick is paired with the SLT4 thermostat and the device is switched to  <temp_scale> scale
  ...
  @SLT4_RegressionTest_GasFurnace @SC-MT-39
    Scenario Outline: SC-MT-39_verify when the device is in dual mode , The temperature values can be set properly
      Given the TGstick is paired with the SLT4 thermostat and the device is switched to  <temp_scale> scale
      When the device is set to dual mode <mode> , with heating set to <heat_temp> and cooling set to <cool_temp>
      Then The heat temperature should be <heat_temp>
      Then The cool temperature should be <cool_temp>
  ...
  @SLT4_RegressionTest_GasFurnace @SC-MT-40
    Scenario Outline: SC-MT-40_verify if the device is able to toggle from Quick heat to Quick cool mode
      Given the TGstick is paired with the SLT4 thermostat and the device is switched to  <temp_scale> scale
  ...
  @SLT4_RegressionTest_GasFurnace @SC-MT-41
    Scenario Outline: SC-MT-41_verify if the user is able to change the boost duration
      Given the TGstick is paired with the SLT4 thermostat and the device is switched to  <temp_scale> scale
  ...
  @SLT4_RegressionTest_GasFurnace @SC-MT-FT-15
    Scenario Outline: SC-MT-FT-15_validate the different device fan modes
      Given the TGstick is paired with the SLT4 thermostat and the device is switched to  <temp_scale> scale
  ...
  @SLT4_RegressionTest_GasFurnace @SC-MT-42
    Scenario Outline: SC-MT-42_validate if the device is able to toggle to different modes and back to the original mode without a set point
      Given the TGstick is paired with the SLT4 thermostat and the device is switched to  <temp_scale> scale
  ...
  @SLT4_RegressionTest_GasFurnace @SC-DT-03
    Scenario Outline: SC-DT-03_validate if the user is able to set the device name on the screen
      Given the TGstick is paired with the SLT4 thermostat and the device is switched to  <temp_scale> scale
  ...
  @SLT4_RegressionTest_GasFurnace @SC-MT-32
    Scenario Outline: SC-MT-32_validate When Quick Cool while already active on stat,the latest temperature should be overridden on stat
      Given the TGstick is paired with the SLT4 thermostat and the device is switched to  <temp_scale> scale
  ...
  @SLT4_RegressionTest_GasFurnace @SC-MT-33
    Scenario Outline: SC-MT-33_validate When Quick heat while already active on stat,the latest temperature should be overridden on stat
      Given the TGstick is paired with the SLT4 thermostat and the device is switched to  <temp_scale> scale
  ...
  @SLT4_RegressionTest_GasFurnace @SC-MT-43
    Scenario Outline: SC-MT-43_validate stat should return to the previous mode once quick heat/ cool is completed
      Given the TGstick is paired with the SLT4 thermostat and the device is switched to  <temp_scale> scale
  ...
  @SLT4_RegressionTest_GasFurnace @SC-MT-35
    Scenario Outline: SC-MT-35_validate stat should return to the previous dual hold when quick heat / cool is completed
      Given the TGstick is paired with the SLT4 thermostat and the device is switched to  <temp_scale> scale
  ...
  @SLT4_RegressionTest_GasFurnace @SC-MT-36
    Scenario Outline: SC-MT-36_validate stat should return to the previous dual schedule when quick heat / cool is completed
      Given the TGstick is paired with the SLT4 thermostat and the device is switched to  <temp_scale> scale
