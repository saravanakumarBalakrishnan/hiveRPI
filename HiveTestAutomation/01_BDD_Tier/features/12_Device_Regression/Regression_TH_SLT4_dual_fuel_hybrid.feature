...
Feature: Regression cases for SLT4 stat in dual fuel hybrid
  ...
  @SLT4_RegressionTest_DualFuel_Hybrid @SC_MT_EM_06
    Scenario Outline: SC_MT_EM_06_verify if the device switches to emergency heat mode
  ...
  @SLT4_RegressionTest_DualFuel_Hybrid @SC-MT-FT-01
    Scenario Outline: SC-MT-FT-01_verify if the fan works when there is a heat demand
      Given the TGstick is paired with the SLT4 thermostat and the device is switched to  <temp_scale> scale
   ...
   @SLT4_RegressionTest_DualFuel_Hybrid @SC-UC-01
    Scenario Outline: SC-UC-01_verify if the stat is able to switch between different temperature Scale
      Given the TGstick is paired with the SLT4 thermostat and the device is switched to  <temp_scale> scale
  ...
  @SLT4_RegressionTest_DualFuel_Hybrid @SC-MT-07
    Scenario Outline: SC-MT-07_verify if the stat is able to be set to quick cool and heat mode
      Given the TGstick is paired with the SLT4 thermostat and the device is switched to  <temp_scale> scale
      When the device is in <device_mode> mode and the required temperature is set to <number> points <value> the ambient temperature
  ...
  @SLT4_RegressionTest_DualFuel_Hybrid @SC-MT-08
    Scenario Outline: SC-MT-08_verify the override values in heat boost and heat hold mode
      Given the TGstick is paired with the SLT4 thermostat and the device is switched to  <temp_scale> scale
  ...
  @SLT4_RegressionTest_DualFuel_Hybrid @SC-MT-09
    Scenario Outline: SC-MT-09_verify the override values in cool boost and cool hold mode
      Given the TGstick is paired with the SLT4 thermostat and the device is switched to  <temp_scale> scale
      When the device is in <device_mode> mode and the required temperature is set to <number> points <value> the ambient temperature without protection timer validation
  ...
  @SLT4_RegressionTest_DualFuel_Hybrid @SC-PT-02
    Scenario Outline: SC-PT-02_verify the protection timer functionality
      Given the TGstick is paired with the SLT4 thermostat and the device is switched to  <temp_scale> scale
  ...
  @SLT4_RegressionTest_DualFuel_Hybrid @SC-MT-10
    Scenario Outline: SC-MT-10_verify when the device is in dual mode , The temperature values can be set properly
      Given the TGstick is paired with the SLT4 thermostat and the device is switched to  <temp_scale> scale
  ...
  @SLT4_RegressionTest_DualFuel_Hybrid @SC-MT-11
    Scenario Outline: SC-MT-11_verify if the device is able to toggle from Quick heat to Quick cool mode
      Given the TGstick is paired with the SLT4 thermostat and the device is switched to  <temp_scale> scale
  ...
  @SLT4_RegressionTest_DualFuel_Hybrid @SC-MT-12
    Scenario Outline: SC-MT-12_verify if the user is able to change the boost duration
      Given the TGstick is paired with the SLT4 thermostat and the device is switched to  <temp_scale> scale
  ...
  @SLT4_RegressionTest_DualFuel_Hybrid @SC-MT-FT-02
    Scenario Outline: SC-MT-FT-02_validate the different device fan modes
      Given the TGstick is paired with the SLT4 thermostat and the device is switched to  <temp_scale> scale
  ...
  @SLT4_RegressionTest_DualFuel_Hybrid @SC-MT-13
    Scenario Outline: SC-MT-13_verify if the device is able to toggle to different modes and back to the original mode without a set point
      Given the TGstick is paired with the SLT4 thermostat and the device is switched to  <temp_scale> scale
  ...
  @SLT4_RegressionTest_DualFuel_Hybrid @SC-DT-01
    Scenario Outline: SC-DT-01_validate if the user is able to set the device name on the screen
      Given the TGstick is paired with the SLT4 thermostat and the device is switched to  <temp_scale> scale
  ...
  @SLT4_RegressionTest_DualFuel_Hybrid @SC-MT-14
    Scenario Outline: SC-MT-14_validate When Quick Cool while already active on stat,the latest temperature should be overridden on stat
      Given the TGstick is paired with the SLT4 thermostat and the device is switched to  <temp_scale> scale
  ...
  @SLT4_RegressionTest_DualFuel_Hybrid @SC-MT-15
    Scenario Outline: SC-MT-15_validate When Quick heat while already active on stat,the latest temperature should be overridden on stat
      Given the TGstick is paired with the SLT4 thermostat and the device is switched to  <temp_scale> scale
  ...
  @SLT4_RegressionTest_DualFuel_Hybrid @SC-MT-16
    Scenario Outline: SC-MT-16_validate stat should return to the previous mode once quick heat/ cool is completed
      Given the TGstick is paired with the SLT4 thermostat and the device is switched to  <temp_scale> scale
  ...
  @SLT4_RegressionTest_DualFuel_Hybrid @SC-MT-17
    Scenario Outline: SC-MT-17_validate stat should return to the previous dual hold when quick heat / cool is completed
      Given the TGstick is paired with the SLT4 thermostat and the device is switched to  <temp_scale> scale
  ...
  @SLT4_RegressionTest_DualFuel_Hybrid @SC-MT-18
    Scenario Outline: SC-MT-18_validate stat should return to the previous dual schedule when quick heat / cool is completed
      Given the TGstick is paired with the SLT4 thermostat and the device is switched to  <temp_scale> scale
