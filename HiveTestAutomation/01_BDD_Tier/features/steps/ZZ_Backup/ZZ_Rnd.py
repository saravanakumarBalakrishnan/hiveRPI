...
AT.startSerialThreads(config.CAMPORT, config.BAUD, True, True, False)
respState,_,_ = AT.sendCommand("root", "#", 5, 5)
print(respState)
expectedResponse = ['uuid(..)']
respState,_,respValue = AT.sendCommand("upgrade_partition --show_info", expectedResponse, 5, 500)
...
speech="Alexa! turn on my heating"
call(["espeak",speech])
