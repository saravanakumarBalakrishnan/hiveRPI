Feature: Validate the functionalities of Contact Sensors
    ...
    @ContactSensor @SC-CS-CS01 @All_Client @V6_App @BasicSmokeTest @AndroidRegression
    Scenario Outline: SC-CS-CS01_Validate the basic operations for Contact Sensor
