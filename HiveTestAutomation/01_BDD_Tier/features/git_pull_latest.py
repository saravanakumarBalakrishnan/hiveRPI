...
def get_kit_details_from_remote_pi():
    ...
    for strPiID in oPiList:
        ...
        getShellCommandOutput(
            "ssh " + strPiID + " \"cd workspace/HiveTestAutomation;git config --global user.email 'rangawillb4u@gmail.com';git config --global user.name 'rangawillb4u';git stash; git pull 'https://rangawillb4u:ranga123@github.com/ConnectedHomes/HiveTestAutomation.git' master; git stash pop\"",
            strPiID)
